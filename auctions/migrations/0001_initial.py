    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categ', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auctions.cat')),
                ('comentarios', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='auctions.comments')),
            ],
        ),
        migrations.CreateModel(
            name='User',
